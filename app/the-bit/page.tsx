...
export default function TheBit() {
  return (
    <main style={{ padding: "56px var(--pad) 90px", maxWidth: 760, margin: "0 auto" }}>
      ...
      <p className="bitp">
        Our pace is conversational, our distance is we&rsquo;ll see, and our mascot is a goat in sunglasses paddling a
        canoe he is not qualified to operate.
      </p>
      ...
      <blockquote className="bitquote">The nap is part of the training.</blockquote>
